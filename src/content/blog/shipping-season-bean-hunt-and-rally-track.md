...
Check out the landing page: [www.beanhunt.app](https://www.beanhunt.app)
...
<div style="text-align: center; margin: 2rem 0;">
  <svg width="80" height="80" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <circle cx="50" cy="50" r="45" fill="#00D563" stroke="#1A1F36" stroke-width="3"/>
    <circle cx="35" cy="35" r="4" fill="#1A1F36"/>
    <circle cx="65" cy="35" r="4" fill="#1A1F36"/>
    <circle cx="50" cy="50" r="4" fill="#1A1F36"/>
    <circle cx="35" cy="65" r="4" fill="#1A1F36"/>
    <circle cx="65" cy="65" r="4" fill="#1A1F36"/>
    <circle cx="50" cy="20" r="4" fill="#1A1F36"/>
    <circle cx="50" cy="80" r="4" fill="#1A1F36"/>
    <circle cx="20" cy="50" r="4" fill="#1A1F36"/>
    <circle cx="80" cy="50" r="4" fill="#1A1F36"/>
  </svg>
</div>
...
Check it out: [Rally Track Site](https://randyventures.github.io/Rally-Track-Site/)
...
**Bean Hunt:** [www.beanhunt.app](https://www.beanhunt.app) — Coffee discovery done right. Coming soon to iOS.

**Rally Track:** [Rally Track Site](https://randyventures.github.io/Rally-Track-Site/) — Pickleball scorekeeping made simple. Submitted for App Store review.
